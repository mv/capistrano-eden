...
CapistranoEden.with_configuration do
  ...
  namespace :deploy do
    ...
    ### setup_vars
    desc "(eden.rb) [internal] Setting up vars"
    ...
    ### show_vars
    desc "(eden.rb) show_vars: Show custom variables defined by eden.rb."
    ...
    ### cleanup_shared
    desc "(eden.rb) [internal] Clean up unused dirs."
